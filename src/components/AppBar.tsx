  ...
  return (
    <div className="bg-dark-char px-5 h-16 flex items-center justify-between flex-shrink-0 border-b-2 border-accent/18 relative z-10">
      <div className="flex items-center gap-2.5">
        <div className="w-[34px] h-[34px] rounded-[9px] bg-card p-[3px] flex items-center justify-center overflow-hidden">
          <img src={politiULogo} alt="PolitiU" className="w-7 h-7 object-contain" />
        </div>
