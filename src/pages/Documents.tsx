...
export default function DocumentsPage() {
  ...
  const handleLinkSummarize = async () => {
    ...
    try {
      ...
      toast.error("Failed to summarize link. Make sure you paste a web URL (https://...).");
      setDocs(prev => prev.filter(d => d.id !== tempId));
    }
  };
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-5">
          {/* Upload zone */}
          <div className="border-2 border-dashed border-primary rounded-[20px] p-8 text-center bg-orange-pale dark:bg-dark-surface mb-5 relative">
            <input
              type="file"
              multiple
