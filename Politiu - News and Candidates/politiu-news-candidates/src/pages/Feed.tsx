      ...
      <div className="bg-dark-surface px-5 pt-4 pb-0">
        <div className="flex items-center justify-between mb-3.5">
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="font-display font-black text-white text-xl">Politi<span className="text-orange-light">U</span></h1>
          </div>
          ...
          {filters.map((f) => (
            <button
              ...
              className={`px-4 py-2.5 rounded-t-2xl text-[11px] font-extrabold tracking-wide whitespace-nowrap transition-colors ${
                activeFilter === f.value ? "bg-background text-dark-surface" : "text-white/40"
              }`}
            >
              {f.label}
            </button>
